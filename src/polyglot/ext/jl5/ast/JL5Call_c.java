...
//                System.err.println("  JL5Call_c.typeCheck mi is " + mi + " container is " + mi.container().getClass());
    ...
    private Type computeReturnType(JL5MethodInstance mi) {
		...
		// applicable then the result type is the erasure (锟�.6) of the method锟絪
		// declared return type.
        // XXX how to check this? We need to implement it properly.

		// Otherwise, if the method being invoked is generic, then for 1 锟�i 锟�n
		// ,
		...
		// let R be the declared return type of the method being invoked. The
		// result type is obtained by applying capture conversion (锟�.1.10) to
		// R[F1 := A1, ..., Fn := An].
		...
		// (锟�.1.10) to the type given in the method declaration.
